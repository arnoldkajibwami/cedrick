                    ...
                    <div>
                        <a href="">
                            <div className="boxdetails">
                                ...
                                <p className="figureLegnde">Mountains and volcanos</p>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="">
                            <div className="boxdetails">
                                ...
                                <p className="figureLegnde">Adventure getaways</p>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="">
                            <div className="boxdetails">
                                ...
                                <p className="figureLegnde">Forest escapes</p>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="">
                            <div className="boxdetails">
                                ...
                                <p className="figureLegnde">Hiking trails</p>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="">
                            <div className="boxdetails">
                                ...
                                <p className="figureLegnde">Street scenes</p>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="">
                            <div className="boxdetails">
                                ...
                                <p className="figureLegnde">Trending</p>
                            </div>
                        </a>
                    </div>
                </div>
